  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        showRedLine && "border-destructive/30 border-b-4 border-b-destructive"
      )}
    >
      {showRedLine && (
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-destructive/80" />
      )}
      {highlight && !showRedLine && (
